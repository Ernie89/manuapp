...
import 'f_hash_tilundervisningen_model.dart';
export 'f_hash_tilundervisningen_model.dart';

class FHashTilundervisningenWidget extends StatefulWidget {
  const FHashTilundervisningenWidget({super.key});

  @override
  State<FHashTilundervisningenWidget> createState() =>
      _FHashTilundervisningenWidgetState();
}

class _FHashTilundervisningenWidgetState
    extends State<FHashTilundervisningenWidget> {
  late FHashTilundervisningenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FHashTilundervisningenModel());
