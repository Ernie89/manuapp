...
import 'ditbarnsflelser_model.dart';
export 'ditbarnsflelser_model.dart';

class DitbarnsflelserWidget extends StatefulWidget {
  const DitbarnsflelserWidget({super.key});

  @override
  State<DitbarnsflelserWidget> createState() => _DitbarnsflelserWidgetState();
}

class _DitbarnsflelserWidgetState extends State<DitbarnsflelserWidget> {
  late DitbarnsflelserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DitbarnsflelserModel());
