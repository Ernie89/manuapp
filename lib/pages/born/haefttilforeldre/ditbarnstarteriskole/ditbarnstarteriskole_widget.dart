...
import 'ditbarnstarteriskole_model.dart';
export 'ditbarnstarteriskole_model.dart';

class DitbarnstarteriskoleWidget extends StatefulWidget {
  const DitbarnstarteriskoleWidget({super.key});

  @override
  State<DitbarnstarteriskoleWidget> createState() =>
      _DitbarnstarteriskoleWidgetState();
}

class _DitbarnstarteriskoleWidgetState
    extends State<DitbarnstarteriskoleWidget> {
  late DitbarnstarteriskoleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DitbarnstarteriskoleModel());
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '3vgjbpgy' /* Dit barn starter i skole */,
            ),
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'rp9rh4wn' /* Dit barn starter i skole */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
