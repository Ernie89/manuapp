...
import 'ditbarnskrop_model.dart';
export 'ditbarnskrop_model.dart';

class DitbarnskropWidget extends StatefulWidget {
  const DitbarnskropWidget({super.key});

  @override
  State<DitbarnskropWidget> createState() => _DitbarnskropWidgetState();
}

class _DitbarnskropWidgetState extends State<DitbarnskropWidget> {
  late DitbarnskropModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DitbarnskropModel());
