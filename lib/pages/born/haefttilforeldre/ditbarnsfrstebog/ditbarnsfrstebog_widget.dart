...
import 'ditbarnsfrstebog_model.dart';
export 'ditbarnsfrstebog_model.dart';

class DitbarnsfrstebogWidget extends StatefulWidget {
  const DitbarnsfrstebogWidget({super.key});

  @override
  State<DitbarnsfrstebogWidget> createState() => _DitbarnsfrstebogWidgetState();
}

class _DitbarnsfrstebogWidgetState extends State<DitbarnsfrstebogWidget> {
  late DitbarnsfrstebogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DitbarnsfrstebogModel());
