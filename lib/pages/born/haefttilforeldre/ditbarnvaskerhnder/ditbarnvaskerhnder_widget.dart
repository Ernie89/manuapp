...
import 'ditbarnvaskerhnder_model.dart';
export 'ditbarnvaskerhnder_model.dart';

class DitbarnvaskerhnderWidget extends StatefulWidget {
  const DitbarnvaskerhnderWidget({super.key});

  @override
  State<DitbarnvaskerhnderWidget> createState() =>
      _DitbarnvaskerhnderWidgetState();
}

class _DitbarnvaskerhnderWidgetState extends State<DitbarnvaskerhnderWidget> {
  late DitbarnvaskerhnderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DitbarnvaskerhnderModel());
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'rgl941n1' /* Dit barn vasker hænder */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
