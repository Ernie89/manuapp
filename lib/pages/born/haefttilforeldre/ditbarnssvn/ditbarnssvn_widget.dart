...
import 'ditbarnssvn_model.dart';
export 'ditbarnssvn_model.dart';

class DitbarnssvnWidget extends StatefulWidget {
  const DitbarnssvnWidget({super.key});

  @override
  State<DitbarnssvnWidget> createState() => _DitbarnssvnWidgetState();
}

class _DitbarnssvnWidgetState extends State<DitbarnssvnWidget> {
  late DitbarnssvnModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DitbarnssvnModel());
