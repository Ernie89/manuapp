...
import 'plakat_model.dart';
export 'plakat_model.dart';

class PlakatWidget extends StatefulWidget {
  const PlakatWidget({super.key});

  @override
  State<PlakatWidget> createState() => _PlakatWidgetState();
}

class _PlakatWidgetState extends State<PlakatWidget> {
  late PlakatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlakatModel());
