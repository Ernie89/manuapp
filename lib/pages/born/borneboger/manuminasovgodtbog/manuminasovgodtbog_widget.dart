...
import 'manuminasovgodtbog_model.dart';
export 'manuminasovgodtbog_model.dart';

class ManuminasovgodtbogWidget extends StatefulWidget {
  const ManuminasovgodtbogWidget({super.key});

  @override
  State<ManuminasovgodtbogWidget> createState() =>
      _ManuminasovgodtbogWidgetState();
}

class _ManuminasovgodtbogWidgetState extends State<ManuminasovgodtbogWidget> {
  late ManuminasovgodtbogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManuminasovgodtbogModel());
