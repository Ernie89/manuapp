...
class ManuminafoldebogBarnetfrstebogWidget extends StatefulWidget {
  const ManuminafoldebogBarnetfrstebogWidget({super.key});

  @override
  State<ManuminafoldebogBarnetfrstebogWidget> createState() =>
      _ManuminafoldebogBarnetfrstebogWidgetState();
}

class _ManuminafoldebogBarnetfrstebogWidgetState
    extends State<ManuminafoldebogBarnetfrstebogWidget> {
  late ManuminafoldebogBarnetfrstebogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManuminafoldebogBarnetfrstebogModel());
