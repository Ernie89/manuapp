...
import 'manuminaskropbog_model.dart';
export 'manuminaskropbog_model.dart';

class ManuminaskropbogWidget extends StatefulWidget {
  const ManuminaskropbogWidget({super.key});

  @override
  State<ManuminaskropbogWidget> createState() => _ManuminaskropbogWidgetState();
}

class _ManuminaskropbogWidgetState extends State<ManuminaskropbogWidget> {
  late ManuminaskropbogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManuminaskropbogModel());
