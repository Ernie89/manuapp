...
import 'manuminalegerbog_model.dart';
export 'manuminalegerbog_model.dart';

class ManuminalegerbogWidget extends StatefulWidget {
  const ManuminalegerbogWidget({super.key});

  @override
  State<ManuminalegerbogWidget> createState() => _ManuminalegerbogWidgetState();
}

class _ManuminalegerbogWidgetState extends State<ManuminalegerbogWidget> {
  late ManuminalegerbogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManuminalegerbogModel());
