...
import 'kunukflytter_opgavehfte_model.dart';
export 'kunukflytter_opgavehfte_model.dart';

class KunukflytterOpgavehfteWidget extends StatefulWidget {
  const KunukflytterOpgavehfteWidget({super.key});

  @override
  State<KunukflytterOpgavehfteWidget> createState() =>
      _KunukflytterOpgavehfteWidgetState();
}

class _KunukflytterOpgavehfteWidgetState
    extends State<KunukflytterOpgavehfteWidget> {
  late KunukflytterOpgavehfteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KunukflytterOpgavehfteModel());
